...
class Ec2CloudwatchStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        super().__init__(scope, construct_id, **kwargs)
         ...
         # The code to create VPC, s3_endpoint, bastion, EC2, EBS, Cloudwatch event rule stop EC2, Backup for EC2
        ...
        host_bastion.allow_ssh_access_from(aws_ec2.Peer.ipv4("0.0.0.0/0"))
